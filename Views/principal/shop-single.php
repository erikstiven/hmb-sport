                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="GET">
                            ...
                            <div class="row pb-3">
                                ...
                                <div class="col d-grid">
                                    <button type="buttom" class="btn btn-success btn-lg" id="btnAddCart" >Añadir al carrito</button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="card rounded-0">
                        ...
                        <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                            <ul class="list-unstyled">
                                ...
                                <li><a class="btn btn-success text-white mt-2" href="<?php echo BASE_URL . 'principal/detail/' . $producto['id']; ?>"><i class="fas fa-eye"></i></a></li><!--accedo al controlador luego al metodo interno-->
