    ...
    public function enviarCorreo()
    {
        if (isset($_POST['correo']) && isset($_POST['token'])) {
            ...
            try {
                ...
                $mail->Subject = 'Mensaje desde la tienda virtual de : ' . TITLE;
                $mail->Body    = 'OJO!! Para verificar tu correo en nuestra tienda <a href ="' . BASE_URL . 'clientes/verificarCorreo/' . $_POST['token'] . ' ">Click aquí</a>';
